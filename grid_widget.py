...
mesh_glyph = MultiLine(xs='xs', ys='ys', line_width=0.7, line_dash=[2, 5],
                       line_color='gold')
...
def render(power=None):
    ...
    sink_source.data['areas'] = [1.8 * sqrt(a) for a in
                                 sink_source.data['areas']]
